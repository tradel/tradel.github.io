...
BLOG_AUTHOR = "Todd Radel"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "codefromthefield"
...
SOCIAL_BUTTONS_CODE = """
<!-- Social buttons -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-58325ff577107d4e"></script>
